...
if (isset($_POST['submit'])) {
  ...
  $insert = "insert into staff(first_name, last_name, sex, phone, email, nid, driver) values('$fname','$lname','$sex', '$phone', '$email', '$nid', '$driver')";
  $affected_rows = mysqli_query($connection, $insert);
  if ($affected_rows) {
  ...
  <?php
    ...
    echo("Something went wrong, data failed to save!");
  }
}
